...
INSERT INTO products (
    ...
    from products
    where productScale = "1:10" or productScale = "1:12";
    
    select quantityInStock, productVendor, productName, buyPrice, MSRP
    from products
    order by quantityInStock, buyPrice desc, MSRP desc;
